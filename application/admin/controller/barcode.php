...
class barcode {
    ...
    private $width = -1;
    private $heith = 40;
    private $quiet_zone = 40;
    private $font_height = 30;
    private $font_type = 4;
    ...
    public function createBarCode($image_type ='png',$ab='',$file_name=null)
    {
        //$file_name = ROOT_BARCODE_IMG.$this->text.'.png';
        $this->parseCode();
        ...
        $bai = imagecolorallocate($this->image, 1, 1, 1);
        /*for($i=0;$i<$t_num;$i++)
        {*/
            //imagechar($this->image,$this->font_type,6*$this->unit_width +$t_sx +$i*$t_x,0,'看',$this->color);
            imagettftext($this->image,10, 0, 10, 18, $bai,EXTEND_PATH . 'file/ht.ttf',$ab);
            //print_r(EXTEND_PATH . 'file/ht.ttf');exit;
        /*}*/
        /* for($i=0;$i<$t_num;$i++)
         {
