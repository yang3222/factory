<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"D:\project\factory\public/../application/admin\view\epwarehouse\warehouse_edit.html";i:1586422157;s:67:"D:\project\factory\application\admin\view\common\mobile_layout.html";i:1585792610;}*/ ?>
<!DOCTYPE html>
...
<body>
    ...
    <div class="canvas">
        ...
        <link rel="stylesheet" href="<?php echo ADMIN_STYLE_URL; ?>css/warehouse.css" type="text/css" media="screen" /><script>$(function(){    warehousetable.btnreload();    warehousetable.start();})</script><div class="canvas_title do-clear">    <ul class="tab_nav fl">        <li class="current"><a href="javaScript:void(0)">仓库编辑</a></li>    </ul>    </div><div class="canvas_intro">        <br/><br/><br/>   <h5 align='center' class='title'><?php echo $list['name']; ?></h5>   <input name="name" type="hidden" value="<?php echo $list['name']; ?>" id="name" readonly="readonly"/>    <input name="id" type="hidden" value="<?php echo $list['id']; ?>" id="id" />    <input type="hidden" class="epaddbtn" value="1">    <input type="hidden" class="epdeletebtn" value="1">    <table class="product" >                        <?php $__FOR_START_1409861811__=$list['x'];$__FOR_END_1409861811__=0;for($i=$__FOR_START_1409861811__;$i > $__FOR_END_1409861811__;$i+=-1){ ?>                    <tr>                    <?php if(is_array($list['warehousetables']) || $list['warehousetables'] instanceof \think\Collection || $list['warehousetables'] instanceof \think\Paginator): $kt = 0; $__LIST__ = $list['warehousetables'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vt): $mod = ($kt % 2 );++$kt;if($i==$vt['p_x']): $childs = GetEpWarehouseChild($vt['id']); if(!empty($childs)): ?>                                                                <td name='father' id='<?php echo $vt['id']; ?>' class="have_child" >                                    <label class='labeltitle'><?php echo $vt['name']; ?></label> <a  class="addbtn">添加子仓库</a>                                    <table class="productchild">                                        <tr>                                            <?php if(is_array($childs) || $childs instanceof \think\Collection || $childs instanceof \think\Paginator): $kc = 0; $__LIST__ = $childs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vc): $mod = ($kc % 2 );++$kc;?>                                            <td name='child' id="<?php echo $vc['id']; ?>"><input type='hidden' id='volume_<?php echo $vc['id']; ?>' name='volume' value="<?php echo $vc['volume']; ?>"  readonly='readonly' >                                                <?php $materials = GetTargets("select * from ink_ep_warehouse_materialdetail where delete_time is NULL and wt_id=".$vc['id']); if(!empty($materials)): ?>                                                    <label  class='title'><?php echo $vc['name']; if($status == "2"): ?>已入库<?php else: ?>计划入库<?php endif; ?></label><br>                                                     <?php if(is_array($materials) || $materials instanceof \think\Collection || $materials instanceof \think\Paginator): $km = 0; $__LIST__ = $materials;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vm): $mod = ($km % 2 );++$km;?>                                                        <label class='material' id="label_<?php echo $vm['id']; ?>"><?php echo $vm['sku']; ?></label><br>                                                    <?php endforeach; endif; else: echo "" ;endif; else: ?>                                                <label class='labeltitle'><?php echo $vc['name']; ?></label><br>                                                <?php if($status == "2"): ?> <a  class="deletebtn">删除</a> <?php else: ?>未规划<?php endif; endif; ?>                                            </td>                                            <?php endforeach; endif; else: echo "" ;endif; ?>                                        </tr>                                    </table>                                </td>                                <?php else: ?>                                    <td name='father' id="<?php echo $vt['id']; ?>"><input type='hidden' id='volume_<?php echo $vt['id']; ?>' name='volume' value="<?php echo $vt['volume']; ?>" readonly='readonly'>                                        <?php $materials = GetTargets("select * from ink_ep_warehouse_materialdetail where delete_time is NULL and wt_id=".$vt['id']); if(!empty($materials)): ?>                                        <label class='title'><?php echo $vt['name']; if($status == "2"): ?>已入库<?php else: ?>计划入库<?php endif; ?></label><br>                                         <?php if(is_array($materials) || $materials instanceof \think\Collection || $materials instanceof \think\Paginator): $km = 0; $__LIST__ = $materials;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vm): $mod = ($km % 2 );++$km;?>                                                                                    <label class='material' id="label_<?php echo $vm['id']; ?>"><?php echo $vm['sku']; ?></label><br>                                                                                <?php endforeach; endif; else: echo "" ;endif; else: ?>                                        <label class='labeltitle'><?php echo $vt['name']; ?></label>                                            <br>                                        <?php if($status == "2"): ?><a  class="addbtn">添加子仓库</a><?php else: ?>未规划<?php endif; endif; ?>                                    </td>                                <?php endif; endif; endforeach; endif; else: echo "" ;endif; ?>                     </tr>            <?php } ?>    </table> <ul class="add_from">     <li>           <label class="label">状态:</label>           <input type="radio" name="status" id="display" <?php if($list['status']==1): ?>checked="checked" <?php endif; ?> value="1" />               <label for="display" >上架</label>           <input type="radio" name="status" id="display1" <?php if($list['status']==0): ?>checked="checked" <?php endif; ?>  value="0" />               <label for="display1">下架</label>       </li>     <li>         <select id="factory_pid" name="factory_pid" >             <option value="0" <?php if($list['factory_pid']==0): ?>selected<?php endif; ?>>成品区域</option>             <option value="1" <?php if($list['factory_pid']==1): ?>selected<?php endif; ?>>半成品区域</option>             <option value="2" <?php if($list['factory_pid']==2): ?>selected<?php endif; ?>>瑕疵品区域</option>         </select>     </li>     <li>         <select id="factory_sid" name="factory_sid">             <option value="1" <?php if($list['factory_sid']==1): ?>selected<?php endif; ?>>免费区</option>             <option value="2" <?php if($list['factory_sid']==2): ?>selected<?php endif; ?>>付费区</option>         </select>     </li>      <li>           <a href="javaScript:warehousetable.update('/admin/epwarehouse/updateWarehouse')">保存</a>       </li>  </ul></div><div class="message" id="tip_windows">    <div class="box">        <h3>添加子仓库<a href="javaScript:windowoperation.hide($('#tip_windows'))" class="close"><img src="<?php echo ADMIN_STYLE_URL; ?>images/closecut.png" /></a></h3>        <br>        <input id="warehouse_child_id" type="hidden" value="" />                            <input name="c_p_y" type="hidden" value="1" id="c_p_y" />        <br>        <li align='center'>            <input name="c_p_x" type="text" value="" id="c_p_x" placeholder="请输入坑位" />        </li>    <br>        <div class="btn"><a href="javaScript:warehousetable.addChild('edit');">确认</a><a href="javaScript:warehousetable.closeTip();">取消</a></div>    </div></div>
