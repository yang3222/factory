<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:91:"D:\project\factory\public/../application/admin\view\warehouse\in_warehouse_mobile_next.html";i:1587880039;s:67:"D:\project\factory\application\admin\view\common\mobile_layout.html";i:1587535506;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="input-box">
        ...
        <ul class="add_from">
            ...
            <li>
                ...
                <a id='btnsave' class="pro_order" href="javaScript:outInWarehouse.searchArrAjax(['<?php echo url('/admin/warehouse/inWarehouse'); ?>','materiald_id','wt_id','count'],'incallback')"><p style="margin: auto">保存</p></a>
            </li>
        </ul>
