<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:98:"D:\project\factory\public/../application/admin\view\epwarehouse\in_warehouse_mobile_countinue.html";i:1587094150;s:67:"D:\project\factory\application\admin\view\common\mobile_layout.html";i:1586935805;}*/ ?>
<!DOCTYPE html>
...
<div class="content-cls">
    <div class="input-box">
        ...
        <ul class="add_from">
            ...
            <li>
<!--                <a id='btnconfig' class="pro_order" href="javaScript:outInWarehouse.configEpWarehouse()"><p style="margin: auto">确认仓位</p></a>-->
                <a id='btnsave' class="pro_order" href="javaScript:outInWarehouse.searchArrAjax(['<?php echo url('/admin/epwarehouse/inWarehouse'); ?>','sku','wt_id','count','wt_name'],'epincallback')"><p style="margin: auto">保存</p></a>
            </li>
        </ul>
