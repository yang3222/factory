<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"D:\project\factory\public/../application/admin\view\epwarehouse\in_warehouse.html";i:1585791621;s:67:"D:\project\factory\application\admin\view\common\mobile_layout.html";i:1586739361;}*/ ?>
<!DOCTYPE html>
...
<body>
    ...
    <div class="canvas">
        ...
        <div class="canvas_title do-clear">    <ul class="tab_nav fl">        <li class="current"><a href="javaScript:void(0)">入库</a></li>    </ul></div><div class="canvas_intro">    <ul class="add_from">                <li id='li_materiald_id' style="display:none;" >            <label class="label">sku：<i></i></label>            <input name="sku" type="text" id="sku" autofocus="autofocus" />        </li>        <li id='li_count' style="display:none;">            <label  class="label">数量：<i>*</i></label>            <input name="count" type="text" value="1" id="count" oninput = "value=value.replace(/[^\d]/g,'')"/><!--readonly="readonly"-->        </li>        <li>            <label class="label">仓位：<i></i></label>            <input name="wt_name" type="text" value="" id="wt_name"  autofocus="autofocus" onkeydown="keyspress()" />            <input name="wt_id" type="hidden" value="" id="wt_id" />        </li>         <li>             <a id='btnconfig' href="javaScript:outInWarehouse.configEpWarehouse()">确认仓位</a>             <a id='btnsave' style='display: none;' href="javaScript:outInWarehouse.searchArrAjax(['<?php echo url('/admin/epwarehouse/inWarehouse'); ?>','sku','wt_id','count','wt_name'],'incallback')">保存</a>        </li>    </ul></div><script type="text/javascript">    function keyspress(frm,event) {        var events = window.event ? window.event : event;        if (events.keyCode == 13) {            outInWarehouse.configEpWarehouse();            //pro_status.search();        }    }</script>
