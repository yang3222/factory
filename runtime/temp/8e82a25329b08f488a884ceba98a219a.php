<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:70:"D:\project\factory\public/../application/admin\view\factory\index.html";i:1585097840;s:60:"D:\project\factory\application\admin\view\common\layout.html";i:1594716292;s:60:"D:\project\factory\application\admin\view\common\member.html";i:1584407225;s:61:"D:\project\factory\application\admin\view\common\topline.html";i:1594716292;s:58:"D:\project\factory\application\admin\view\common\menu.html";i:1584407225;s:61:"D:\project\factory\application\admin\view\common\mapline.html";i:1584407225;}*/ ?>
...
<div class="canvas_title do-clear">
    <ul class="tab_btn tab_btn_fl fl">
        <li><a href="<?php echo url('/admin/factory/add'); ?>">添加</a></li>
    </ul>
</div>
    ...
    <table class="productli">
        ...
        <tbody>
            ...
            <tr class="navline">
                ...
                <td class="center">
                    <?php if(is_array($value['fac_attribute_arr']) || $value['fac_attribute_arr'] instanceof \think\Collection || $value['fac_attribute_arr'] instanceof \think\Paginator): $facattk = 0; $__LIST__ = $value['fac_attribute_arr'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$facatt): $mod = ($facattk % 2 );++$facattk;?>
                    <?php echo $fac_att[$facatt]; if($facattk < count($value['fac_attribute_arr'])): ?>，<?php else: endif; endforeach; endif; else: echo "" ;endif; ?>
                </td>
                ...
                <td class="center operation">
                    <a href="<?php echo url('/admin/factory/edit','id='.$value['id']); ?>">编辑</a>
                </td>
            </tr>
            <?php endforeach; endif; else: echo "" ;endif; ?>
        </tbody>
