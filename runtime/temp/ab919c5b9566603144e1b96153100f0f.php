<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:87:"D:\project\factory\public/../application/admin\view\warehouse\out_warehouse_mobile.html";i:1587533941;s:67:"D:\project\factory\application\admin\view\common\mobile_layout.html";i:1587535506;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="input-box">
        ...
        <ul class="add_from">
            ...
            <li id='li_materiald_id' >
                ...
                <input name="materiald_id" type="text" value="" id="materiald_id" onkeydown="outInWarehouse.key(event,13,outInWarehouse.getmaterialDetail,['<?php echo url('/admin/warehouse/getmaterialDetail'); ?>','materiald_id'])"    />
            </li>
            ...
            <li id='li_count' >
                ...
                <input name="count"  type="text" value="" id="count" />
            </li>

            <li>
                <a id='out' class="pro_order"  href="javaScript:outInWarehouse.searchArrAjax(['<?php echo url('/admin/warehouse/outWarehouse'); ?>','materiald_id','count'],'outcallback')"><p style="margin: auto">出库</p></a>
            </li>
        </ul>
