<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"D:\project\factory\public/../application/admin\view\login\mobile_login.html";i:1584407225;}*/ ?>
<!doctype html>
<html class="no-js">
<head>
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="<?php echo ADMIN_STYLE_URL; ?>css/amazeui.min.css" type="text/css" media="screen" />
    ...
    <script type="text/javascript" src="<?php echo ADMIN_STYLE_URL; ?>js/login.js"></script>
    <script>
        $(function(){
    ...
    <div class="am-g myapp-login">
        <div class="myapp-login-bg">
            <div class="myapp-login-logo">
                ...
                <img src="<?php echo ADMIN_STYLE_URL; ?>images/login_logo.png" />
            </div>
                    ...
                    <fieldset>
                        ...
                        <div id="account_login">
                            ...
                            <div class="am-form-group">
                                ...
                                <img title="点击刷新" id="codeimg" src="<?php echo url('/admin/login/code'); ?>" onclick="imgcode();" style="width: 49%;height: 38px; float: right;"/>
                            </div>
