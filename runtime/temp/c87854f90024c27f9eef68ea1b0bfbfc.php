<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:78:"D:\project\factory\public/../application/admin\view\orderexcel\exportdata.html";i:1584407225;s:60:"D:\project\factory\application\admin\view\common\layout.html";i:1584407225;s:60:"D:\project\factory\application\admin\view\common\member.html";i:1584407225;s:61:"D:\project\factory\application\admin\view\common\topline.html";i:1584407225;s:58:"D:\project\factory\application\admin\view\common\menu.html";i:1584407225;s:61:"D:\project\factory\application\admin\view\common\mapline.html";i:1584407225;}*/ ?>
...
<div class="canvas_intro">
    ...
    <form method="post" action="<?php echo url('/admin/orderexcel/exportexcel'); ?>" enctype="multipart/form-data"  onsubmit="return importent();" class="im_form">
...
<script>
    ...
    var excel9610 = {
        ...
        delete:function(id) {
            ...
            $.post("<?php echo url('/admin/orderexcel/delete'); ?>",{id:id}, function(res) {
                if (res['code'] == 1000) {
                    alert(res['msg']);
                    window.location = "<?php echo url('/admin/orderexcel/index'); ?>";
                } else {
                    alert(res['msg']);
                    window.location = "<?php echo url('/admin/orderexcel/index'); ?>";
                }
