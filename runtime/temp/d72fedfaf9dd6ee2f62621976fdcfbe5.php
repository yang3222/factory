<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:89:"D:\project\factory\public/../application/admin\view\epwarehouse\out_warehouse_mobile.html";i:1587004530;s:67:"D:\project\factory\application\admin\view\common\mobile_layout.html";i:1587535506;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="input-box">
        ...
        <ul class="add_from">
            ...
            <li id='li_materiald_id' >
                ...
                <input name="sku" type="text" value="" id="sku" autofocus="autofocus" onkeydown="outInWarehouse.key(event,13,outInWarehouse.getEpmaterialDetail,['<?php echo url('/admin/epwarehouse/getEpmaterialDetail'); ?>','sku'])"    />
            </li>
            <li id='li_count' >
                <label  class="label">数量：<i>*</i></label>
                <input name="count"  type="text" value="1" id="count" />
            </li>

            <li>
                <a id='out' class="pro_order"  href="javaScript:outInWarehouse.searchArrAjax(['<?php echo url('/admin/epwarehouse/outWarehouse'); ?>','sku','count'],'epoutcallback')"><p style="margin: auto">出库</p></a>
            </li>
        </ul>
