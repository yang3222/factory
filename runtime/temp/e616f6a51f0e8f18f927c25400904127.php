<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:86:"D:\project\factory\public/../application/admin\view\productionmanage\mobile_index.html";i:1585097840;s:67:"D:\project\factory\application\admin\view\common\mobile_layout.html";i:1585792610;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="ul-list" >
        ...
        <ul id="fac_li">
            <?php if(is_array($pri) || $pri instanceof \think\Collection || $pri instanceof \think\Paginator): $k = 0; $__LIST__ = $pri;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$value): $mod = ($k % 2 );++$k;?>
                <li class="fac_li" onclick="li_click('fac_li', this)" data-fac="<?php echo $value['id']; ?>">
                    <?php echo $value['userinfo']['Name']; ?>
                </li>
    ...
    <div class="ul-list">
        ...
        <ul id="mac_li">
            <?php if(is_array($fac) || $fac instanceof \think\Collection || $fac instanceof \think\Paginator): $k = 0; $__LIST__ = $fac;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$value): $mod = ($k % 2 );++$k;?>
                <li class="mac_li" onclick="li_click('mac_li', this)" data-fac="<?php echo $value['id']; ?>">
                    <?php echo $value['userinfo']['Name']; ?>
                </li>
            <?php endforeach; endif; else: echo "" ;endif; ?>
        </ul>
