<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:86:"D:\project\factory\public/../application/admin\view\epwarehouse\in_warehouse_next.html";i:1587881348;s:60:"D:\project\factory\application\admin\view\common\layout.html";i:1584407225;s:60:"D:\project\factory\application\admin\view\common\member.html";i:1584407225;s:61:"D:\project\factory\application\admin\view\common\topline.html";i:1584407225;s:58:"D:\project\factory\application\admin\view\common\menu.html";i:1584407225;s:61:"D:\project\factory\application\admin\view\common\mapline.html";i:1584407225;}*/ ?>
...
<div class="canvas_intro">
    ...
    <ul class="add_from">
        ...
        <li id='li_materiald_id'>
            <label class="label">sku：<i></i></label>
            <input name="sku" type="text" id="sku" autofocus="autofocus"/>
        </li>

        <li id='li_count'>
            <label  class="label">数量：<i>*</i></label>
            <input name="count" type="text" value="1" id="count" oninput = "value=value.replace(/[^\d]/g,'')"/><!--readonly="readonly"-->
        </li>
        <li>
            <label class="label">仓位：<i></i></label>
            <input name="wt_name" type="text" value="<?php echo $wt_name; ?>" id="wt_name" readonly autofocus="autofocus" onkeydown="keyspress()" />
            <input name="wt_id" type="hidden" value="<?php echo $wt_id; ?>" id="wt_id" />
        </li>
        <li>
            <a id='btnsave' href="javaScript:outInWarehouse.searchArrAjax(['<?php echo url('/admin/epwarehouse/inWarehouse'); ?>','sku','wt_id','count','wt_name'],'epincallback')">保存</a>
        </li>
    </ul>
    <div id="msg" style="margin-left: 180px"></div>
</div>
...
<script type="text/javascript">
    function keyspress(frm,event) {
        ...
        if (events.keyCode == 13) {
            outInWarehouse.configEpWarehouse();
            //pro_status.search();
        }
    }
</script>
