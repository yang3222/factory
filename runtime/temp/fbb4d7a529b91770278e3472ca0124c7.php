<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:88:"D:\project\factory\public/../application/admin\view\epwarehouse\in_warehouse_mobile.html";i:1587094366;s:67:"D:\project\factory\application\admin\view\common\mobile_layout.html";i:1587535506;}*/ ?>
<!DOCTYPE html>
...
<!--                <a id='btnsave' class="pro_order" style='display: none;' href="javaScript:outInWarehouse.searchArrAjax(['<?php echo url('/admin/epwarehouse/inWarehouse'); ?>','sku','wt_id','count','wt_name'],'epincallback')"><p style="margin: auto">保存</p></a>-->
            </li>
        </ul>
